...
<body>
        ...
        <div class="form-container">
            ...
            <form id="addCourseForm" method="POST" onsubmit="return validateForm()">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control" id="content_link" name="content_link" required>
    ...
    <script>
        function validateForm() {
            ...
            // Validation du lien du cours
            const urlPattern = /^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/;
            if (!urlPattern.test(contentLink)) {
                document.getElementById('contentLinkError').textContent = 'Le lien du cours n\'est pas valide.';
                isValid = false;
            } else {
                document.getElementById('contentLinkError').textContent = '';
            }
